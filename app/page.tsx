  ...
  return (
    <main>
      ...
      <div className='px-4 md:px-12'>
        <section>
          <h2 className='font-bold border-b-2 border-slate-600 leading-8'>About me</h2>
          <p className='mt-4'>
            Hello! 👋🏻 I am a Computer Engineer with experience as a Web Developer, specializing in both frontend and backend technologies.
            In addition, I am a strong advocate for <b>mental health awareness</b>.

          </p>
        </section>
        <section className='mt-12'>
          <h2 className='font-bold border-b-2 border-slate-600 leading-8'>Experience</h2>
          ...
          <section className='mt-4'>
            <h3 className='font-semibold'>Bridge For Billions · Frontend Developer Intern </h3>
            <h4>01/2017 – 11/2017</h4>
          </section>
          </section>
          <section className='mt-12'>
          <h2 className='font-bold border-b-2 border-slate-600 leading-8'>Education</h2>
          <section className='mt-4'>
            <h3 className='font-semibold'>KeepCoding · Full Stack Web Developer Bootcamp</h3>
            <h4 className='mb-2'>11/2018 – 10/2019</h4>
          </section>
          <section className='mt-4'>
            <h3 className='font-semibold'>Technical University of Madrid · Bachelor’s Degree of Computer Engineering</h3>
            <h4 className='mb-2'>9/2011 – 01/20189</h4>
          </section>
          </section>
        <section className='mt-12'>
          <h2 className='font-bold border-b-2 border-slate-600 leading-8'>Skills</h2>
          <section className='mt-4'>
        ...
        <section className='mt-12'>
          <h2 className='font-bold border-b-2 border-slate-600 leading-8'>Languages</h2>
